		...
		<div id="container_box">
			...
			<section id="content">
				...
				<ul>
					...
					<li>
						<div class="data1">
 						<img src="${pageContext.request.contextPath } /resources/imgs/gucci_a/${approvelist.data1}">
						</div>	
						<div class="data3" style="text-align:bottom;"> ${approvelist.data3} </div>
						<div class="data2" style="text-align:center;">
						<fmt:formatNumber value ="${approvelist.data2}" pattern="###,###,###" />
						</div>
