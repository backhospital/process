				...
				<ul>
					...
					<li>
						<div class="data1">
 						...
 						<img src="${pageContext.request.contextPath } /resources/imgs/gucci_a/${list.data1}">
						</div>	
						<div class="data3" style="text-align:bottom;"> ${list.data3} </div>
...
<!-- 					일정글자수가 길어지면 끊어지는 코드삽입 필요 정보를 구해봐야 함.. -->
						<div class="data2" style="text-align:center;">
						<fmt:formatNumber value ="${list.data2}" pattern="###,###,###" />
						</div>
	...
	<!-- Core theme JS-->
	<script src="${pageContext.request.contextPath}/resources/a/js/scripts.js"></script>
	<!-- JS sector -->
	<script>
