...
<!-- 			<form role="form" method="post" autocomplete="off"> -->
			<input type="hidden" name="idx" value="${rejectlist.idx}"/>
		
			
			<div class="inputArea">
				<label for="productid">브랜드명</label>
				<span>${rejectlist.productid}</span>
			</div>
			
			<div class="inputArea">
				<label for="data3">상품명</label>
				<span>${rejectlist.data3}</span>
			</div>
			
			<div class="inputArea">
				<label for="data2">제안가격</label>
				<span><fmt:formatNumber value="${rejectlist.data2}" pattern="###,###,###"/></span>
			</div>
					
			<div class="inputArea">
				<label for="data4">상품소개</label>				
				<div class="data4">${rejectlist.data4}</div>	
			</div>
			
			<div class="inputArea">
				<label for="data1">이미지</label>
				<p>원본 이미지</p>
				<img src="${pageContext.request.contextPath } /resources/imgs/gucci_a/${rejectlist.data1}" class="oriImg"/>
