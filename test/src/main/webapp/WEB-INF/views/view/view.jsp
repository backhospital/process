...
<div id="root">
		...
		<div id="container_box">
			...
			<div class="inputArea">
				...
				<span>${view.productid}</span>
			</div>
			
			<div class="inputArea">
				<label for="data3">상품명</label>
				<span>${view.data3}</span>
			</div>
			
			<div class="inputArea">
				<label for="data2">제안가격</label>
				<span><fmt:formatNumber value="${view.data2}" pattern="###,###,###"/></span>
			</div>
					
			<div class="inputArea">
				<label for="data4">상품소개</label>				
				<div class="data4">${view.data4}</div>	
			</div>
			
			<div class="inputArea">
				<label for="data1">이미지</label>
				<p>원본 이미지</p>
				<img src="${pageContext.request.contextPath } /resources/imgs/gucci_a/${view.data1}" class="oriImg"/>
