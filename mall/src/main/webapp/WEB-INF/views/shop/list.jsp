          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt mb-0">상품 페이지</h1>
              </div>
            </div>
          </div>
        </section>
			...
			<section id="content">
				<ul>
					...
					<li>
						...
						<div class="name" style="text-align:center;"><h4 class="font-alt mb-0"><a href="/shop/view?n=${list.gdsNum}">${list.gdsName}</a></h4></div>
					</li>
					</c:forEach>					
				</ul>
			</section>
