          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt mb-0">관리자 유저 수정 페이지</h1>
              </div>
            </div>
          </div>
        </section>
...
<!-- Main과 footer구간 시작         -->
        <section class="module">
          <div class="container">
            <div class="row">
              <div class="col-sm-5">
                <h4 class="font-alt">${memberview.userId}님의 정보수정하기</h4>
                <hr class="divider-w mb-10">
                <form method="post">
                <h3>주의!! SQL 구문 변경으로 새로운 명령어 DAO/SERVICE/CONTROLLER 입력필요!!</h3>
				<label>회원등급</label>
				
				<textarea rows="1" cols="5" name="verify">${memberModify.verify}</textarea>
				
				<button class="btn btn-block btn-round btn-b" type="submit" id="signup_btn" name="signup_btn">수정하기</button>
