          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt mb-0">관리자 주문목록 페이지</h1>
              </div>
            </div>
          </div>
        </section>
...
<!--  main footer 구간 시작      -->       
		...
		<h4 class="font-alt mb-0"><a href="/admin/shop/orderList2" >배송완료 목록보기</a></h4>
		</div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <h4 class="font-alt mb-0">배송준비 / 배송중 목록보기</h4>
                <hr class="divider-w mt-10 mb-20">
