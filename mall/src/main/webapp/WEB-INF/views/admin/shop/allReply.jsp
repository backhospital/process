...
<!-- 상단 섹션구간 시작 -->
        <section class="module bg-dark-30" data-background="${pageContext.request.contextPath}/resources/images/css/admin5.jpg">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt mb-0">관리자 댓글보기 페이지</h1>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <h4 class="font-alt mb-0">모든 상품 댓글보기</h4>
			...
			<li>
				...
				<div class="replyControll">
					...
					<form role="form" method="post">
						...
						<button type="submit" class="btn btn-d btn-round_${reply.repNum}">삭제</button>
